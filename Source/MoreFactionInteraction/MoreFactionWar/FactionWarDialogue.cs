...
namespace MoreFactionInteraction.MoreFactionWar
{
    ...
    public class FactionWarDialogue
    {
        ...
        public DiaNode FactionWarPeaceTalks()
        {
            ...
            var dialogueGreeting = new DiaNode(text: "MFI_FactionWarPeaceTalksIntroduction".Translate( factionOneLeaderName, factionInstigatorLeaderName, _pawn.Label ));
        ...
        {
            var factionWarNegotiationsOutcome = "Something went wrong with More Faction Interaction. Please contact mod author.";
        ...
        private static void Outcome_TalksSabotageDisaster(Faction favouredFaction, Faction burdenedFaction, Pawn pawn, IIncidentTarget incidentTarget)
        {
            ...
            LongEventHandler.QueueLongEvent(action: delegate
            {
                ...
                var list = PawnGroupMakerUtility.GeneratePawns(parms: defaultPawnGroupMakerParms).ToList();
                ...
                var burdenedFactionWarriors = PawnGroupMakerUtility.GeneratePawns(parms: burdenedFactionPawnGroupMakerParms).ToList();
        ...
        {
            return MFI_DiplomacyTunings.BadOutcomeFactorAtStatPower.Evaluate(_pawn.GetStatValue(stat: StatDefOf.NegotiationAbility));
        }
    }
