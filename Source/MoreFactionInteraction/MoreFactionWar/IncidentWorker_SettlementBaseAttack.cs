...
namespace MoreFactionInteraction
{
    public class IncidentWorker_SettlementAttack : IncidentWorker
    {
        ...
        protected override bool TryExecuteWorker(IncidentParms parms)
        {
            ...
            {
                if (TileFinder.TryFindPassableTileWithTraversalDistance(rootTile: root, minDist: 7, maxDist: 66, result: out var num))
                {
                    return num;
                }
            ...
            if (!TileFinder.TryFindRandomPlayerTile(tile: out var randomPlayerTile, allowCaravans: true, validator: x => FindTile(root: x) != -1))
            {
                return false;
            }
            ...
            {
                return Find.WorldObjects.AnySettlementAt(tile: x) &&
            ...
            TileFinder.TryFindPassableTileWithTraversalDistance(rootTile: someRandomPreferablyNearbySettlement.Tile,
                                                                ...
                                                                result: out var tileContainingAlly,
                                                                validator: HasNearbyAlliedFaction);

            TileFinder.TryFindPassableTileWithTraversalDistance(rootTile: someRandomPreferablyNearbySettlement.Tile,
                                                                minDist: 0, maxDist: 66,
                                                                result: out var tileContainingEnemy,
        ...
        private static string DestroyOldOutpostAndCreateNewAtSpot(Settlement someRandomPreferablyNearbySettlement)
        {
            ...
            var destroyedSettlement = (DestroyedSettlement)WorldObjectMaker.MakeWorldObject(def: WorldObjectDefOf.DestroyedSettlement);
